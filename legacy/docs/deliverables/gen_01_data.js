...
const children = [
  ...
  C.dataTable(
    ["레이블", "Train", "Eval", "설명"],
    [
      ["conditional", "883건", "100건", "조건부 허용 (승인/조건 필요)"],
      ["yes", "772건", "100건", "규정상 무조건 허용/가능"],
      ["no_regulation", "665건", "67건", "관련 규정 없음"],
      ["no", "629건", "61건", "규정상 명확히 금지/불가"],
    ],
    [1500, 1200, 1000, 3372]
  ),
  C.body(""),
  ...
  C.bullet("Judgment v2 학습 완료 후 no/conditional 경계 정확도 개선 확인 (v1: 전체 86.6%, conditional 84% → 목표 90%+)"),
