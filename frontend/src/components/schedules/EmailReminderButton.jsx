  ...
  return (
    <div className="inline-flex flex-col">
      <button
        onClick={handleSend}
        disabled={sending}
        className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md border border-neutral-border text-[11px] text-neutral-sub hover:bg-accent-50 hover:text-accent-700 hover:border-accent-300 transition disabled:opacity-50"
      >
