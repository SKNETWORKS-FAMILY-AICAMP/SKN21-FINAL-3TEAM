export default function MeetLinkBadge({ meetLink }) {
  ...
  return (
    <a
      ...
      className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-primary-50 text-primary-700 text-[11px] font-medium hover:bg-primary-100 transition"
    >
