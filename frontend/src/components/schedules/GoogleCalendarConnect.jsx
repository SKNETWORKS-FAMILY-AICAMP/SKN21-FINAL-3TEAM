export default function GoogleCalendarConnect({ connected = false, email }) {
  return (
    <div className="flex items-center gap-3 px-5 py-3.5 bg-surface-card border border-neutral-border rounded-2xl mb-5">
      <div className={`flex items-center gap-1.5 text-[0.8125rem] font-medium ${connected ? 'text-success' : 'text-neutral-muted'}`}>
