  ...
  return (
    <>
      <header className={`bg-surface-main flex-shrink-0 z-20 transition-all duration-300 ease-in-out ${isScrolled ? 'h-[56px] shadow-sm' : 'h-[100px]'}`}>
        <div className={`grid grid-cols-[1fr_auto_1fr] items-center px-10 h-full transition-all duration-300 ease-in-out ${isScrolled ? 'py-2.5' : 'py-[30px]'}`}>

          {/* 좌측 - 로고 */}
          <div className="flex items-center">
            <a href="/dashboard" className="flex items-center gap-2.5">
              <img src="/logo.png" alt="Logo" className={`object-contain transition-all ${isScrolled ? 'h-7' : 'h-10'}`} />
