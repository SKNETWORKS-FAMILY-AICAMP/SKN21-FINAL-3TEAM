...
```
실험 5 best (전처리 없음):  Adversarial ~91-93% (212문장 기준)
...
|------|-----|
| Eval F1 (macro) | **98.63%** |
| Adversarial Accuracy (120문장, 실험 5~6에서 212문장으로 확장) | **91.67%** |
...
6. **검증 강화** → adversarial 212개로 확장하여 더 엄격한 기준에서 재검증 (실험 5~6 공통)
