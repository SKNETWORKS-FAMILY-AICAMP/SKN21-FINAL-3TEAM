...
| 지표 | v1.0 | v1.1 | 변화 |
|------|:----:|:----:|:----:|
| Accuracy | 0.9905 | _학습 후 기록_ | |
| F1 (macro) | 0.9908 | _학습 후 기록_ | |
| F1 (weighted) | 0.9905 | _학습 후 기록_ | |

### Adversarial 테스트
| 항목 | v1.0 | v1.1 | 변화 |
|------|:----:|:----:|:----:|
| 총점 | 18/25 (72%) | _테스트 후 기록_ | |
| judgment→general 오분류 | 5건 | _테스트 후 기록_ | |
| 비정형→general 오분류 | 2건 | _테스트 후 기록_ | |
