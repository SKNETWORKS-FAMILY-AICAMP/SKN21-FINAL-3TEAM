...
FIELD_MAPPING = {
    ...
    "추진일정": {"key": "schedule", "desc": '추진 일정 배열. 각 항목은 {"phase": "단계", "task": "업무", "period": "기간"} 형태'},
    "일정": {"key": "schedule", "desc": '추진 일정 배열. 각 항목은 {"phase": "단계", "task": "업무", "period": "기간"} 형태'},
    "예산": {"key": "budget", "desc": '예산 배열. 각 항목은 {"item": "항목", "amount": "금액"} 형태'},
    "소요예산": {"key": "budget", "desc": '예산 배열. 각 항목은 {"item": "항목", "amount": "금액"} 형태'},
